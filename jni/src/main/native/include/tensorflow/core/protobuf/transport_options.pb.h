...
#ifndef PROTOBUF_tensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto_INCLUDED
#define PROTOBUF_tensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::tensorflow::RecvBufRespExtra* Arena::Create< ::tensorflow::RecvBufRespExtra>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class RecvBufRespExtra : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.RecvBufRespExtra) */ {
 public:
  ...
  inline RecvBufRespExtra* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<RecvBufRespExtra>(NULL);
  }

  RecvBufRespExtra* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<RecvBufRespExtra>(arena);
  }
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto::InitDefaultsRecvBufRespExtraImpl();
};
// ===================================================================
...
#endif  // PROTOBUF_tensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto_INCLUDED
