...
JNIEXPORT void JNICALL Java_org_platanios_tensorflow_jni_Session_00024_delete(JNIEnv* env,
                                                                          jobject object,
                                                                          jlong handle) {
...
JNIEXPORT jbyteArray JNICALL Java_org_platanios_tensorflow_jni_Session_00024_run(
    JNIEnv* env, jobject object, jlong handle, jbyteArray jrun_options,
