...
In this release we have:
  ...
  - Added support for the lazy Adam optimizer, the
    [AMSGrad](https://openreview.net/pdf?id=ryQu7f-RZ) optimizer and
    the [YellowFin](https://arxiv.org/pdf/1706.03471.pdf) optimizer.
